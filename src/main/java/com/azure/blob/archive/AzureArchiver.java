...
import static com.azure.blob.archive.ZipConstants64.EFS;
import static com.azure.blob.archive.ZipConstants64.EXTID_EXTT;
import static com.azure.blob.archive.ZipConstants64.EXTID_ZIP64;
import static com.azure.blob.archive.ZipConstants64.EXTT_FLAG_LAT;
import static com.azure.blob.archive.ZipConstants64.EXTT_FLAG_LMT;
import static com.azure.blob.archive.ZipConstants64.EXTT_FLAT_CT;
import static com.azure.blob.archive.ZipConstants64.ZIP64_ENDHDR;
import static com.azure.blob.archive.ZipConstants64.ZIP64_ENDSIG;
import static com.azure.blob.archive.ZipConstants64.ZIP64_EXTID;
import static com.azure.blob.archive.ZipConstants64.ZIP64_LOCSIG;
import static com.azure.blob.archive.ZipConstants64.ZIP64_MAGICCOUNT;
import static com.azure.blob.archive.ZipConstants64.ZIP64_MAGICVAL;
import static com.azure.blob.archive.ZipUtils.fileTimeToUnixTime;
import static com.azure.blob.archive.ZipUtils.get16;

public
class AzureArchiver extends DeflaterOutputStream implements ZipConstants {
     ...
     */
    public AzureArchiver(OutputStream out, ArchiveUtil archiveUtil, String fileName)
    {
        this(out, StandardCharsets.UTF_8, archiveUtil, fileName);
     ...
     * @since 1.7
     */
    public AzureArchiver(OutputStream out, Charset charset, ArchiveUtil archiveUtil, String fileName) {
...
//                    }
    ...
    private void createBlock() {
        ByteBuffer byteBuffer = ByteBuffer.wrap(baos.toByteArray().clone());
        try {
            blocks.add(archiveUtil.uploadBlock(baos.toByteArray().clone(), fileName));
    ...
    public void uploadFromURL(URL url) throws IOException {
        try {
            closeEntry();
            blocks.add(archiveUtil.uploadBlockFromUrl(url ,fileName));
        } catch (MalformedURLException e) {
            e.printStackTrace();
        } catch (InvalidKeyException e) {
            e.printStackTrace();
    ...
    public void close() throws IOException {
        if (!closed) {
            ...
            closed = true;
            try {
                archiveUtil.commitBlockList(blocks, fileName);
            } catch (InvalidKeyException e) {
                e.printStackTrace();
            }
        }
